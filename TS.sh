...
case $contact in
  1)
    ...
    ;;
  2)
    am start -a android.intent.action.VIEW -d "https://www.facebook.com/profile.php?id=61553657020034" > /dev/null 2>&1
    ;;
  3)
    am start -a android.intent.action.SENDTO -d "mailto:tahiryandriatefy52@gmail.com" > /dev/null 2>&1
    ;;
  0)
    echo "Ok, on continue..."
    ;;
